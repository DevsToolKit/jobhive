...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<'li'>) {
  return (
    <li
      ...
      className={cn('group/menu-item relative flex items-center group-data-[collapsible=icon]:justify-center', className)}
      {...props}
    />
  );
}
